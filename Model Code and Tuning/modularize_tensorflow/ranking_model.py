...
import data_processing_ranking
...
def compute_unique(N):
    ...
    unique_user_ages_binned,unique_occupations,unique_languages
...
class RankingModel(tf.keras.Model):
    ...
    def call(self, inputs):
        ...
        return self.ratings(tf.concat(
            [user_embedding, movie_embedding, age_embedding, gender_embedding, occupation_embedding, lenght_embedding,
             year_embedding, genre_embedding, language_embedding], axis=1))
