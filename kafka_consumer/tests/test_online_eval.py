...
from kafka_consumer.online_eval import calculate_MRR, g_r_r_f
...
def test_online_eval():
    consumer = [
        ...
        "2047,22211,re, 200, result: +in+, a, +v, b+a, a+c, a, in+a++w+2010, e+v+1988, q+a+c, the+v+b, w+1, s, d+o, a+v, a+a+a+1949, w, v, b+a, s, 1+s, 107 ms",
    ...
    rec_list = g_r_r_f(4, 10, consumer)
    for rec in rec_list:
        print(rec.user)
