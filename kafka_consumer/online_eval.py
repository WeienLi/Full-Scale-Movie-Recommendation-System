...
from kafka_consumer.utils.constants import MessageType
from kafka_consumer.utils.message_parser import parse_message
...
def g_r_r_f(num_recommendation, time_span, consumer):
    recommendatins = (
        []
