...
from online_eval import (calculate_accept_rate,
                         get_recommendation_request_feedback)
...
def test_online_eval():
    consumer = [
        ...
        "2022-10-07T14:21:02,2223,GET /data/m/e+v+1988/17.mpg",
        "2022-10-07T14:21:02,2223,GET /data/m/w+1/17.mpg",
    ...
    assert accpet_rates[0] == 0.15
    assert accpet_rates[1] == 0.15
    assert accpet_rates[2] == 0.2
